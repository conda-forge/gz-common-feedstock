...
```
conda install gz-common gz-common5 libgz-common libgz-common5
```
...
```
mamba install gz-common gz-common5 libgz-common libgz-common5
```
...
pixi add gz-common gz-common5 libgz-common libgz-common5
# for installing globally
pixi global install gz-common gz-common5 libgz-common libgz-common5
```
...
It is possible to list all of the versions of `gz-common` available on your platform:
...
```
pixi search gz-common --channel conda-forge
```
